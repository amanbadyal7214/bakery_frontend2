  ...
  return (
    <section id="menu" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-[0.8rem] font-bold tracking-[0.2em] uppercase text-[#F5CB73] mb-3">Our Menu</p>
          <h2 className="font-playfair text-4xl md:text-5xl font-bold text-[#434144] mb-4">Made to Delight</h2>
          <p className="text-[#686669] max-w-xl mx-auto text-base leading-relaxed">
          ...
          {products.slice(0, 8).map((p, i) => (
            ...
            >
              ...
              <Link to={`/product/${getProdId(p)}`} className="block h-full w-full"> 
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#353336] via-[#434144]/60 to-transparent opacity-90" />
                  ...
                  <div className="transform transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                    <div className="flex justify-between items-end mb-1.5">
                      <div className="flex flex-col gap-0.5">
                        {p.badge && (
                          <span className="w-fit px-2 py-0.5 rounded-full bg-[#F5CB73] text-[#353336] text-[0.6rem] font-bold uppercase tracking-wider mb-0.5">
                            {p.badge}
                          </span>
                        )}
                        <h3 className="font-playfair text-lg font-bold leading-tight group-hover:text-[#F5CB73] transition-colors">
                          {p.name}
                        </h3>
                      </div>
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-1">
                        <Star className="w-3 h-3 fill-[#F5CB73] text-[#F5CB73]" />
                    ...
                    <button 
                      ...
                      className="w-full bg-white text-[#353336] font-bold py-2.5 text-sm rounded-full hover:bg-[#F5CB73] hover:text-[#353336] transition-colors shadow-lg active:scale-95 duration-200"
                    >
                      Add to Order
                    </button>
                  </div>
        ...
        >
          <button
            ...
            className="border-2 border-[#F5CB73] text-[#F5CB73] bg-transparent px-8 py-3.5 rounded-full font-semibold hover:bg-[#F5CB73] hover:text-[#353336] transition-all duration-200 hover:-translate-y-0.5 cursor-pointer"
          >
            See Full Menu
          </button>
        </motion.div>
